...
from app.api import audit, auth, departments_admin, maintenance, metrics, resident_merges, residents_admin, roles, system, users, workflow
...
app.include_router(resident_merges.router)
app.include_router(residents_admin.router)
